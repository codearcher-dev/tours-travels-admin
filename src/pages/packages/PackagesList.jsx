...
import { Edit, Trash2, Plus, Search, X, IndianRupee, Clock, Info, CheckCircle2, XCircle, MapPin, List, XOctagon, Map, Utensils, Activity } from 'lucide-react';
      ...
      {selectedPackage && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            <div className="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
