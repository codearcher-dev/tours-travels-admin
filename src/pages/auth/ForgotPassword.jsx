      ...
      <div className="w-full max-w-md space-y-8 bg-white p-10 shadow-xl ring-1 ring-gray-900/5 rounded-2xl relative z-10">
        ...
        {submitted ? (
          <div className="text-center space-y-6 mt-8">
             ...
             <div>
               <Link to="/login" className="inline-flex items-center justify-center gap-2 font-semibold text-primary-600 hover:text-primary-500 transition-colors bg-primary-50 px-6 py-2.5 rounded-lg w-full">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center text-sm pt-2">
              <Link to="/login" className="inline-flex items-center gap-1 font-semibold text-gray-500 hover:text-gray-900 transition-colors">
                <ArrowLeft className="w-4 h-4" />
                Back to login
              </Link>
            </div>
